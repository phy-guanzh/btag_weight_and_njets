...
// Sun Jan 23 17:47:09 2022 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: cutlep-outTTGJets18.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nIsoTrack;
   Float_t         IsoTrack_dxy[19];   //[nIsoTrack]
   Float_t         IsoTrack_dz[19];   //[nIsoTrack]
   Float_t         IsoTrack_eta[19];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[19];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[19];   //[nIsoTrack]
   Float_t         IsoTrack_phi[19];   //[nIsoTrack]
   Float_t         IsoTrack_pt[19];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[19];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[19];   //[nIsoTrack]
   Int_t           IsoTrack_charge[19];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[19];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[19];   //[nIsoTrack]
   Bool_t          IsoTrack_isHighPurityTrack[19];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[19];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[19];   //[nIsoTrack]
   UInt_t          nJet;
   ...
   Float_t         LowPtElectron_ID[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_convVtxRadius[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_deltaEtaSC[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxy[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxyErr[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_dz[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_dzErr[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_eInvMinusPInv[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_embeddedID[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_energyErr[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_eta[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_hoe[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_mass[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_all[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_chg[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_phi[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_pt[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_ptbiased[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_r9[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_scEtOverPt[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_sieie[10];   //[nLowPtElectron]
   Float_t         LowPtElectron_unbiased[10];   //[nLowPtElectron]
   Int_t           LowPtElectron_charge[10];   //[nLowPtElectron]
   Int_t           LowPtElectron_convWP[10];   //[nLowPtElectron]
   Int_t           LowPtElectron_pdgId[10];   //[nLowPtElectron]
   Bool_t          LowPtElectron_convVeto[10];   //[nLowPtElectron]
   UChar_t         LowPtElectron_lostHits[10];   //[nLowPtElectron]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   Int_t           Tau_charge[9];   //[nTau]
   Int_t           Tau_decayMode[9];   //[nTau]
   Int_t           Tau_jetIdx[9];   //[nTau]
   ...
   Int_t           LowPtElectron_genPartIdx[10];   //[nLowPtElectron]
   UChar_t         LowPtElectron_genPartFlav[10];   //[nLowPtElectron]
   ...
   Float_t         Jet_pt_jerUp[28];   //[nJet]
   Float_t         Jet_mass_jerUp[28];   //[nJet]
   ...
   Float_t         Jet_pt_jerDown[28];   //[nJet]
   Float_t         Jet_mass_jerDown[28];   //[nJet]
   ...
   Float_t         Jet_btagSF_deepcsv_M_down[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_M[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_M_up[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_hf[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_cferr1[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jes[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_cferr2[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_lf[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_lf[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_cferr1[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_lfstats1[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_lfstats2[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_hfstats1[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_hfstats2[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_lfstats2[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_hf[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_lfstats1[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jes[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_hfstats2[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_hfstats1[25];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_cferr2[25];   //[nJet]
   ...
   virtual float    get_btag_scale(TH1D*hbeff,TH1D*hceff,TH1D*hleff,double value,int nJet, float Jet_btagDeepFlavB[30],int Jet_hadronFlavour[30], float Jet_btagSF_deepjet[30],float Jet_btagSF_deepjet_up[30],float Jet_btagSF_deepjet_down[30],float Jet_pt[30], float Jet_eta[30],TString type);
   virtual void     Loop(TString year,TString name);
   virtual void     endJob();
 ...
 private:
     ...
     TFile *fout;
     float mT_pf,mT2_pf;
     float mT_puppi,mT2_puppi,ml1g,ml2g;
     float HLT_SF,HLT_SF_Up,HLT_SF_Down;
     float Btag_Weight;
     float Btag_Weight_Up;
     float Btag_Weight_Down;
     float btag_weight_medium_b,btag_weight_medium_c,btag_weight_medium_light,btag_weight_medium_light_up,btag_weight_medium_light_down;
     float btag_weight_medium_b_up,btag_weight_medium_b_down;
     float btag_weight_medium_c_up,btag_weight_medium_c_down;
     int  njet_30_jesup,njet_30_jesdown,nbjet_20_jesup,nbjet_20_jesdown,njet_30_jerup,njet_30_jerdown,nbjet_20_jerup,nbjet_20_jerdown;
     int njet_30_test;
};
...
#ifdef WWg_cxx
WWg::WWg(TTree *tree,TString dataset) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("cutlep-outTTGJets18.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("cutlep-outTTGJets18.root");
      }
...
Int_t WWg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WWg::LoadTree(Long64_t entry)
{
...
void WWg::Init(TTree *tree)
{
   ...
   //fout = new TFile("/home/pku/guanz/cms/all_rootfiles/"+m_dataset, "RECREATE");
   //fout = new TFile("~/cms/update_btag/"+m_dataset, "RECREATE");
   //fout = new TFile("/home/pku/guanz/cms/updatejesr/"+m_dataset, "RECREATE");
   fout = new TFile("./"+m_dataset, "RECREATE");
   ExTree = fChain->CloneTree(0);
   ExTree->Branch("mT_pf",&mT_pf,"mT_pf/F");
   ExTree->Branch("mT2_pf",&mT2_pf,"mT2_pf/F");
   ExTree->Branch("mT_puppi",&mT_puppi,"mT_puppi/F");
   ExTree->Branch("mT2_puppi",&mT2_puppi,"mT2_puppi/F");
   ExTree->Branch("ml1g",&ml1g,"ml1g/F");
   ExTree->Branch("ml2g",&ml2g,"ml2g/F");
   ExTree->Branch("HLT_SF",&HLT_SF,"HLT_SF/F");
   ExTree->Branch("HLT_SF_Up",&HLT_SF_Up,"HLT_SF_Up/F");
   ExTree->Branch("HLT_SF_Down",&HLT_SF_Down,"HLT_SF_Down/F");
   ExTree->Branch("Btag_Weight",&Btag_Weight,"Btag_Weight/F");
   ExTree->Branch("njet_30_jesup",&njet_30_jesup,"njet_30_jesup/I");
   ExTree->Branch("njet_30_test",&njet_30_test,"njet_30_test/I");
   ExTree->Branch("njet_30_jesdown",&njet_30_jesdown,"njet_30_jesdown/I");
   ExTree->Branch("njet_30_jerup",&njet_30_jerup,"njet_30_jerup/I");
   ExTree->Branch("njet_30_jerdown",&njet_30_jerdown,"njet_30_jerdown/I");
   ExTree->Branch("nbjet_20_jerup",&nbjet_20_jerup,"nbjet_20_jerup/I");
   ExTree->Branch("nbjet_20_jerdown",&nbjet_20_jerdown,"nbjet_20_jerdown/I");
   ExTree->Branch("nbjet_20_jesup",&nbjet_20_jesup,"nbjet_20_jesup/I");
   ExTree->Branch("nbjet_20_jesdown",&nbjet_20_jesdown,"nbjet_20_jesdown/I");
   ExTree->Branch("btag_weight_medium_b",&btag_weight_medium_b,"btag_weight_medium_b/F");
   ExTree->Branch("btag_weight_medium_c",&btag_weight_medium_c,"btag_weight_medium_c/F");
   ExTree->Branch("btag_weight_medium_light",&btag_weight_medium_light,"btag_weight_medium_light/F");
   ExTree->Branch("btag_weight_medium_b_up",&btag_weight_medium_b_up,"btag_weight_medium_b_up/F");
   ExTree->Branch("btag_weight_medium_c_up",&btag_weight_medium_c_up,"btag_weight_medium_c_up/F");
   ExTree->Branch("btag_weight_medium_b_down",&btag_weight_medium_b_down,"btag_weight_medium_b_down/F");
   ExTree->Branch("btag_weight_medium_c_down",&btag_weight_medium_c_down,"btag_weight_medium_c_down/F");
   ExTree->Branch("btag_weight_medium_light_up",&btag_weight_medium_light_up,"btag_weight_medium_light_up/F");
   ExTree->Branch("btag_weight_medium_light_down",&btag_weight_medium_light_down,"btag_weight_medium_light_down/F");
